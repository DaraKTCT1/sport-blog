...
const PostComponent = ({ post }: PropType) => {
  ...
  return (
    <Link href={`/posts/${post?.slug?.current}`}>
      <article className="mb-8 w-full h-80 lg:h-96 rounded-md shadow-sm shadow-purple-950 hover:shadow-md hover:bg-purple-500 hover:text-white bg-[#e7ecef] hover:bg-white1 dark:bg-dark2 hover:dark:bg-dark1">
